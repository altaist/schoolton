...
<head>
    ...
    <script>
        ...
        // Замените XXXX на ID вашей метрики
...
<body>
        ...
        <div class="container position-relative z-2 my-5">
            <div class="row justify-content-center align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    @if($flags['redir'] === $flags['price_block']['main'])
                        <!-- Версия с ценой в главном блоке -->
                    ...
                    @elseif($flags['redir'] === $flags['price_block']['separate'])
                        <!-- Версия с ценой в отдельном блоке -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center">
          <p class="mb-4 theme-text-primary">Немного полезной информации о натальных картах</p>
          <h2 class="h1 fw-bold mb-4 theme-text-dark">10 интересных фактов о натальных картах</h2>
        </div>
          ...
          <div class="row">
            <div class="col-12 col-md-6 col-lg-4 mb-3">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="36.918" height="50.297" viewBox="0 0 36.918 50.297">
                ...
                <h3 class="h6 fw-bold mt-4 mb-2">Древние корни</h3>
                <p class="font-small theme-text-accent-three">Натальные карты, или карты рождения, используются в астрологии уже тысячи лет. Их корни уходят в древние цивилизации, такие как Вавилон и Египет, где астрологи анализировали расположение звезд и планет для предсказания событий и понимания человеческой природы.</p>
              </div>
            </div>
            <!-- repetable -->
            <div class="col-12 col-md-6 col-lg-4 mb-3">
              <div class="py-5 px-5 mb-4 mb-lg-0 theme-border-radius cardeffect">
                ...
                <h3 class="h6 fw-bold mt-4 mb-2">Уникальность</h3>
                <p class="font-small theme-text-accent-three">Каждая натальная карта уникальна, так как она строится на основе точного времени, даты и места рождения человека. Даже небольшие изменения в этих параметрах могут значительно повлиять на интерпретацию карты.</p>
              </div>
            </div>
            <!-- repetable -->
            <div class="col-12 col-md-6 col-lg-4 mb-3">
              <div class="py-5 px-5 mb-4 mb-lg-0 theme-border-radius cardeffect">
                ...
                <h3 class="h6 fw-bold mt-4 mb-2">Двенадцать домов</h3>
                <p class="font-small theme-text-accent-three">Натальная карта делится на двенадцать домов, каждый из которых отвечает за определенные аспекты жизни, такие как личность, финансы, коммуникации, семья, творчество и другие. Положение планет в этих домах помогает астрологам делать выводы о различных сферах жизни человека</p>
              </div>
            </div>
            <!-- repetable -->
            <div class="col-12 col-md-6 col-lg-4 mb-3">
              <div class="py-5 px-5 mb-4 mb-lg-0 theme-border-radius cardeffect">
                ...
                <h3 class="h6 fw-bold mt-4 mb-2">Асцендент</h3>
                <p class="font-small theme-text-accent-three">Асцендент, или восходящий знак, является одним из самых важных элементов натальной карты. Он определяется знаком Зодиака, который восходил на восточном горизонте в момент рождения, и влияет на внешнее поведение и впечатление, которое человек производит на окружающих</p>
              </div>
            </div>
            <!-- repetable -->
            <div class="col-12 col-md-6 col-lg-4 mb-3">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="39.106" height="50.176" viewBox="0 0 39.106 50.176">
                ...
                <h3 class="h6 fw-bold mt-4 mb-2">Транзиты</h3>
                <p class="font-small theme-text-accent-three">стрологи используют натальные карты не только для анализа личности, но и для прогнозирования будущих событий. Транзиты планет через различные дома и аспекты натальной карты помогают предсказать периоды перемен, вызовов и возможностей в жизни человека.</p>
              </div>
            </div>
            <!-- repetable -->
            <div class="col-12 col-md-6 col-lg-4 mb-3">
              <div class="py-5 px-5 mb-4 mb-lg-0 theme-border-radius cardeffect">
                ...
                <h3 class="h6 fw-bold mt-4 mb-2">Синастрия</h3>
                <p class="font-small theme-text-accent-three">Натальные карты могут использоваться для анализа совместимости между людьми. Сравнение карт двух человек позволяет астрологам выявить гармоничные и напряженные аспекты в отношениях, что помогает лучше понять динамику взаимодействия.</p>
              </div>
            </div>
            <!-- repetable -->
            <div class="col-12 col-md-6 col-lg-4 mb-3">
              <div class="py-5 px-5 mb-4 mb-lg-0 theme-border-radius cardeffect">
                ...
                <h3 class="h6 fw-bold mt-4 mb-2">Лунные узлы</h3>
                <p class="font-small theme-text-accent-three">В натальной карте особое внимание уделяется лунным узлам — Северному и Южному. Они указывают на кармические уроки и задачи, которые человек должен пройти в этой жизни, а также на опыт, накопленный в прошлых воплощениях</p>
              </div>
            </div>
            <!-- repetable -->
            <div class="col-12 col-md-6 col-lg-4 mb-3">
              <div class="py-5 px-5 mb-4 mb-lg-0 theme-border-radius cardeffect">
                ...
                <h3 class="h6 fw-bold mt-4 mb-2">Ретроаградные планеты</h3>
                <p class="font-small theme-text-accent-three">Планеты, которые кажутся движущимися назад (ретроградными) в момент рождения, также играют важную роль в натальной карте. Они указывают на области жизни, где человек может испытывать задержки или необходимость пересмотра и переосмысления.</p>
              </div>
            </div>
            <!-- repetable -->
            <!-- repetable -->
            <div class="col-12 col-md-6 col-lg-4 mb-3">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="36.918" height="50.297" viewBox="0 0 36.918 50.297">
                ...
                <h3 class="h6 fw-bold mt-4 mb-2">Элементы и качества</h3>
                <p class="font-small theme-text-accent-three">Знаки Зодиака в натальной карте делятся на четыре элемента (огонь, земля, воздух и вода) и три качества (кардинальные, фиксированные и мутабельные). Баланс этих элементов и качеств в карте помогает понять, как человек реагирует на мир и взаимодействует с окружающими.</p>
              </div>
            </div>
            <!-- repetable -->
            <!-- repetable -->
            <div class="col-12 col-md-6 col-lg-4 mb-3">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="39.106" height="50.176" viewBox="0 0 39.106 50.176">
                ...
                <h3 class="h6 fw-bold mt-4 mb-2">Прогрессии</h3>
                <p class="font-small theme-text-accent-three">Помимо транзитов, астрологи используют метод прогрессий для прогнозирования событий. Прогрессии основаны на идее, что каждый день после рождения соответствует одному году жизни, и позволяют увидеть, как изменяются и развиваются аспекты натальной карты с течением времени.</p>
              </div>
            </div>
            <!-- repetable -->
          </div>
    ...
    <section class="features" data-aos="fade-up">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-12 text-center">
                    <h2 class="h1 fw-bold mb-4 theme-text-accent-one">Факты и цифры нашего сервиса</h2>
                    <p class="mb-0 theme-text-accent-two max-2">Присоединяйтесь к активному сообществу!</p>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <h3 class="h5 fw-bold mb-4 mt-5 mt-lg-5">Документы</h3>
                    <div class="q-pa-md">
                        <div class="docs q-my-sm"><a href="/docs/persondata.pdf">Политика персональных данных</a></div>
                        <div class="docs q-my-sm"><a href="/docs/return.pdf">Порядок возврата денежных средств</a></div>
                        <div class="docs q-my-sm"><a href="/docs/order.pdf">Правила оформления заказа</a></div>
                        <div class="docs q-my-sm"><a href="/docs/oferta.pdf">Публичная оферта</a></div>
                    </div>
                </div>
            </div>
