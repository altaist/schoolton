...
<body>
        ...
        <div class="container position-relative z-2">
            <div class="row justify-content-center align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <p class="mb-5 theme-text-accent-two display-6"> Нам доверяют. Более 1000 выполненных исследований!</p>
                    <div class="group">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-12 text-center">
                    <h2 class="h1 fw-bold mb-4 theme-text-accent-one">Интересные факты</h2>
          ...
          <span class="d-block fw-bold theme-text-accent-one fs-4">Запросов на консультации</span>
        </div-->
                <!-- repetable -->
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0 text-center">
                    <div class="key-bg">
                ...
                <div class="col-12 col-lg-7">
                    <div class="action-bg text-center text-lg-start">
                        ...
                        <div class="group mt-5">
                            <button class="rounded-pill btn custom-btn-primary font-small primary-btn-effect" onClick="window.location='/astro-order'">Заказать натальную карту</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section >
        ...
        <form class="form-subcriber">
            <div class="row">
                <div class="col-12">
                    <input type="email" name="email" value="" placeholder="Ваш email *" class="form-control">

                </div>
                <div class="col">
                    <input type="email" name="email" value="" placeholder="Ваш телефон *">

                </div>
                <div class="col">
                    <input type="email" name="email" value="" placeholder="Контакт в ">
        ...
        <div class="container">
            ...
            <div class="row mt-5 pt-5 border-top">
                <div class="col-12 col-md-12 text-center">
                    ...
                    <p class="pt-2 mb-0 font-extra-small">&copy; Copyright 2024 Сервис Натальных карт.</p>
                </div>
            </div>
        </div>
    </footer>
