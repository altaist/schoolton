    ...
    <div class="container position-relative z-2">
      <div class="row justify-content-center align-items-center">
        <div class="col-12 col-lg-6" >
          ...
          <h1 class="display-1 fw-bold mb-3 theme-text-white animate-charcter">Удобный и быстрый сервис заказа натальных карт
          </h1>
      ...
      <!-- Order Form-->
    <section class="section section-xl" style="margin: 0px; color:white; background-color: #6a5570">
        <div class="container pt-3">
          <h2 class="wow fadeInLeft text-center my-5">Заказать натальную карту</h2>
          <div>
            <OrderForm/>
          </div>
        </div>
